...
export const metadata: Metadata = {
  ...
  description: `精选 ${tools.length}+ AI 工具，涵盖 AI 对话、图像生成、视频创作、编程辅助、音频合成、办公效率、智能搜索等 7 大分类。帮你快速找到最适合的 AI 工具。`,
  openGraph: {
    title: "AI 工具导航 — 发现最优秀的 AI 工具",
    description: `精选 ${tools.length}+ AI 工具，涵盖 7 大分类。帮你快速找到最适合的 AI 工具。`,
  },
};
